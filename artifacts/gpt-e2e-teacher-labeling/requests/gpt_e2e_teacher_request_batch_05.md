...
{
  "batch_id": "gpt_e2e_teacher_batch_05",
  "patients": [
    {
      "patient_id": "SYN-GEN-00021",
      "patient_information_string": "Oncology referral note: SYN-GEN-00021 is a 24-year-old male with thyroid eye disease. Stage is recorded as III. ECOG performance status is 3. Molecular testing results are not available in the note. No prior systemic therapy is listed in the referral. No explicit exclusion comorbidities are addressed. The patient receives care in CA. The note is a synthetic record created for software testing, not a real patient chart.",
    ...
    {
      "patient_id": "SYN-GEN-00022",
      "patient_information_string": "Tumor board intake: SYN-GEN-00022 is a 18-year-old male with advanced renal cell carcinoma. No formal stage is documented. ECOG performance status is 1. Molecular testing results are not available in the note. No prior systemic therapy is listed in the referral. No explicit exclusion comorbidities are addressed. The patient receives care in NY. The note is a synthetic record created for software testing, not a real patient chart.",
      "synthetic_source_profile": {
        "patient_id": "SYN-GEN-00022",
        "age": 18,
        "sex": "male",
        ...
        "target_trial_id": "NCT07570316"
      },
      "candidate_trials": [
        {
          "trial_id": "NCT07570316",
          "title": "A Study to Assess Efficacy and Safety of Efgartigimod PH20 SC PFS in Adult Participants With Graves' Disease",
          "source_url": "https://clinicaltrials.gov/study/NCT07570316",
          "retrieval_rank": 1,
          "retrieval_score": 1.0,
          "conditions": [
            "Graves' Disease",
          ...
          "criteria_to_assess": [
            {
              "criterion_id": "NCT07570316-I-condition",
              "criterion_type": "inclusion",
              "criterion": "Patient diagnosis should match the trial condition.",
              "structured_value": [
                "Graves' Disease",
            ...
            {
              "criterion_id": "NCT07570316-I-age",
              "criterion_type": "inclusion",
              "criterion": "Patient age should be within trial bounds.",
              "structured_value": {
                "min_age": 18,
    ...
    {
      "patient_id": "SYN-GEN-00023",
      "patient_information_string": "Oncology referral note: SYN-GEN-00023 is a 55-year-old female with graves ophthalmopathy. Stage is recorded as IV. ECOG performance status is not documented. Molecular testing results are not available in the note. No prior systemic therapy is listed in the referral. No uncontrolled cardiac disease is reported. The patient receives care in TX. The note is a synthetic record created for software testing, not a real patient chart.",
      "synthetic_source_profile": {
        "patient_id": "SYN-GEN-00023",
        "age": 55,
        "sex": "female",
        ...
        "target_trial_id": "NCT06693856"
      },
      "candidate_trials": [
        {
          "trial_id": "NCT06693856",
          "title": "Multi-center Prospective Clinical Study on Glucocorticoid Pulse Therapy for Graves' Ophthalmopathy (GO)",
          "source_url": "https://clinicaltrials.gov/study/NCT06693856",
          "retrieval_rank": 1,
          "retrieval_score": 1.0,
          "conditions": [
          ...
          "criteria_to_assess": [
            {
              "criterion_id": "NCT06693856-I-condition",
              "criterion_type": "inclusion",
              "criterion": "Patient diagnosis should match the trial condition.",
              "structured_value": [
                "Graves Ophthalmopathy"
            ...
            {
              "criterion_id": "NCT06693856-I-age",
              "criterion_type": "inclusion",
              "criterion": "Patient age should be within trial bounds.",
              "structured_value": {
                "min_age": 25,
            ...
            {
              "criterion_id": "NCT06693856-E-uncontrolled-cardiac-disease",
              "criterion_type": "exclusion",
              "criterion": "Exclude if patient has uncontrolled cardiac disease.",
              "structured_value": "uncontrolled_cardiac_disease",
              "required": true
          ...
          "raw_criteria_excerpt": {
            ...
            "exclusion": [
              ...
              "7. Subjects with a white blood cell count \\<4.010\\^9/L, or a platelet count \\<8010\\^9/L.",
    ...
    {
      "patient_id": "SYN-GEN-00024",
      "patient_information_string": "Tumor board intake: SYN-GEN-00024 is a 31-year-old female with graves disease. Stage is recorded as IV. ECOG performance status is 2. Molecular testing results are not available in the note. No prior systemic therapy is listed in the referral. No active autoimmune disease is reported. The patient receives care in WA. The note is a synthetic record created for software testing, not a real patient chart.",
      "synthetic_source_profile": {
        "patient_id": "SYN-GEN-00024",
        "age": 31,
        "sex": "female",
        ...
        "target_trial_id": "NCT07305818"
      },
      "candidate_trials": [
        {
          "trial_id": "NCT07305818",
          "title": "NEXUS Study: A Study to Test Single and Multiple Doses of MER511 Given to Adults With Graves' Disease",
          "source_url": "https://clinicaltrials.gov/study/NCT07305818",
          "retrieval_rank": 1,
          "retrieval_score": 1.0,
          "conditions": [
            "Graves Disease"
          ...
          "criteria_to_assess": [
            {
              "criterion_id": "NCT07305818-I-condition",
              "criterion_type": "inclusion",
              "criterion": "Patient diagnosis should match the trial condition.",
              "structured_value": [
                "Graves Disease"
            ...
            {
              "criterion_id": "NCT07305818-I-age",
              "criterion_type": "inclusion",
              "criterion": "Patient age should be within trial bounds.",
              "structured_value": {
                "min_age": 18,
            ...
            {
              "criterion_id": "NCT07305818-E-active-autoimmune-disease",
              "criterion_type": "exclusion",
              "criterion": "Exclude if patient has active autoimmune disease.",
              "structured_value": "active_autoimmune_disease",
              "required": true
    ...
    },
    {
      ...
      "synthetic_source_profile": {
        ...
        "target_trial_id": "NCT06334692"
      },
      "candidate_trials": [
        {
          "trial_id": "NCT06334692",
          "title": "Autoantibodies Against-nephrin in Idiopathic Nephrotic Syndrome",
          "source_url": "https://clinicaltrials.gov/study/NCT06334692",
          "retrieval_rank": 1,
          "retrieval_score": 1.0,
          "conditions": [
            "Nephrotic Syndrome"
          ...
          "criteria_to_assess": [
            {
              "criterion_id": "NCT06334692-I-condition",
              "criterion_type": "inclusion",
              "criterion": "Patient diagnosis should match the trial condition.",
              "structured_value": [
                "Nephrotic Syndrome"
            ...
            {
              "criterion_id": "NCT06334692-I-age",
              "criterion_type": "inclusion",
              "criterion": "Patient age should be within trial bounds.",
              "structured_value": {
                "min_age": 18,
          ...
          "raw_criteria_excerpt": {
            ...
            "eligibility_criteria_excerpt": "Inclusion Criteria: * Adult (\\>18 years) males and females * Patients with biopsy-proven idiopathic MCD or FSGS (cases) * Patients with biopsy-proven idiopathic membranous nephropathy (controls) * Patients who provided consent to store their samples in the certified CRB biobank Exclusion Criteria: * Reasonable possibility of a secondary cause of NS (for cases) or MN (for controls) at time of blood collections * Active viral or bacterial infections at time of blood collections"
          }
        },
        {
          "trial_id": "NCT03237780",
