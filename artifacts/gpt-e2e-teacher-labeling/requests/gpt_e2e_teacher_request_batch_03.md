...
{
  "batch_id": "gpt_e2e_teacher_batch_03",
  "patients": [
    {
      "patient_id": "SYN-GEN-00011",
      "patient_information_string": "Oncology referral note: SYN-GEN-00011 is a 56-year-old male with pancreatitis, acute. No formal stage is documented. ECOG performance status is 1. Molecular testing results are not available in the note. No prior systemic therapy is listed in the referral. No explicit exclusion comorbidities are addressed. The patient receives care in CA. The note is a synthetic record created for software testing, not a real patient chart.",
      "synthetic_source_profile": {
        "patient_id": "SYN-GEN-00011",
        "age": 56,
        "sex": "male",
        "diagnosis": "pancreatitis, acute",
        "ecog": 1,
        "location": {
          "country": "US",
          "state": "CA"
        ...
        "target_trial_id": "NCT05955235"
      },
      "candidate_trials": [
        {
          "trial_id": "NCT05955235",
          "title": "A Long-term Safety Follow-up Study of SCM-AGH in Patients Who Completed SCM-APT2001 Study",
          "source_url": "https://clinicaltrials.gov/study/NCT05955235",
          "retrieval_rank": 1,
          "retrieval_score": 1.0,
          "conditions": [
            "Pancreatitis, Acute"
          ...
          "criteria_to_assess": [
            {
              "criterion_id": "NCT05955235-I-condition",
            ...
            {
              "criterion_id": "NCT05955235-I-age",
              "criterion_type": "inclusion",
          ...
          "raw_criteria_excerpt": {
            ...
            "exclusion": [],
            "eligibility_criteria_excerpt": "Inclusion Criteria: * Subjects who provide written informed consent * Subjects who have received at least 1 dose of SCM-AGH in the SCM-APT2001 study Exclusion Criteria: * N/A"
          }
        },
        {
    ...
    {
      "patient_id": "SYN-GEN-00012",
      "patient_information_string": "Tumor board intake: SYN-GEN-00012 is a 62-year-old female with acute pancreatitis. Stage is recorded as I. ECOG performance status is 1. Molecular testing results are not available in the note. No prior systemic therapy is listed in the referral. No uncontrolled cardiac disease is reported. The patient receives care in NY. The note is a synthetic record created for software testing, not a real patient chart.",
      "synthetic_source_profile": {
        "patient_id": "SYN-GEN-00012",
        "age": 62,
        "sex": "female",
        ...
        "target_trial_id": "NCT03684278"
      },
      "candidate_trials": [
        {
          "trial_id": "NCT03684278",
          "title": "Randomised Treatment of Acute Pancreatitis With Infliximab: Double-blind, Placebo-controlled, Multi-centre Trial (RAPID-I)",
          "source_url": "https://clinicaltrials.gov/study/NCT03684278",
          "retrieval_rank": 1,
          "retrieval_score": 1.0,
          "conditions": [
            "Acute Pancreatitis"
          ...
          "criteria_to_assess": [
            {
              "criterion_id": "NCT03684278-I-condition",
              "criterion_type": "inclusion",
              "criterion": "Patient diagnosis should match the trial condition.",
              "structured_value": [
                "Acute Pancreatitis"
            ...
            {
              "criterion_id": "NCT03684278-I-age",
              "criterion_type": "inclusion",
              "criterion": "Patient age should be within trial bounds.",
              "structured_value": {
                "min_age": 18,
            ...
            {
              "criterion_id": "NCT03684278-I-stage",
              "criterion_type": "inclusion",
              "criterion": "Patient disease stage should be allowed.",
              "structured_value": [
                "IV"
            ...
            {
              "criterion_id": "NCT03684278-E-uncontrolled-cardiac-disease",
              "criterion_type": "exclusion",
              "criterion": "Exclude if patient has uncontrolled cardiac disease.",
              "structured_value": "uncontrolled_cardiac_disease",
              "required": true
          ...
          "raw_criteria_excerpt": {
            ...
            "exclusion": [
              ...
              "Multiple sclerosis, systemic vasculitis, Guillain-Barr syndrome or other demyelinating disorder",
              "Known epilepsy",
    ...
    },
    {
      ...
      "synthetic_source_profile": {
        ...
        "target_trial_id": "NCT07620405"
      },
      "candidate_trials": [
        {
          "trial_id": "NCT07620405",
          "title": "Open-Label Extension Study of MHB018A in Patients With Thyroid Eye Disease",
          "source_url": "https://clinicaltrials.gov/study/NCT07620405",
          "retrieval_rank": 1,
          "retrieval_score": 1.0,
          "conditions": [
          ...
          "criteria_to_assess": [
            {
              "criterion_id": "NCT07620405-I-condition",
              "criterion_type": "inclusion",
              "criterion": "Patient diagnosis should match the trial condition.",
              "structured_value": [
                "Thyroid Eye Disease (TED)"
            ...
            {
              "criterion_id": "NCT07620405-I-age",
              "criterion_type": "inclusion",
              "criterion": "Patient age should be within trial bounds.",
              "structured_value": {
                "min_age": 18,
    ...
    {
      "patient_id": "SYN-GEN-00014",
      "patient_information_string": "Tumor board intake: SYN-GEN-00014 is a 41-year-old female with metastatic colorectal cancer. Stage is recorded as IV. ECOG performance status is 1. Molecular testing results are not available in the note. No prior systemic therapy is listed in the referral. No active autoimmune disease is reported. No uncontrolled cardiac disease is reported. The patient receives care in WA. The note is a synthetic record created for software testing, not a real patient chart.",
      "synthetic_source_profile": {
        "patient_id": "SYN-GEN-00014",
        "age": 41,
        "sex": "female",
        ...
        "target_trial_id": "NCT05461820"
      },
      "candidate_trials": [
        {
          "trial_id": "NCT05461820",
          "title": "Effects of Different Treatment Schemes on the Regulation and Recurrence of Graves' Disease",
          "source_url": "https://clinicaltrials.gov/study/NCT05461820",
          "retrieval_rank": 1,
          "retrieval_score": 1.0,
          "conditions": [
            "Graves Disease",
          ...
          "criteria_to_assess": [
            {
              "criterion_id": "NCT05461820-I-condition",
              "criterion_type": "inclusion",
              "criterion": "Patient diagnosis should match the trial condition.",
              "structured_value": [
                "Graves Disease",
            ...
            {
              "criterion_id": "NCT05461820-I-age",
              "criterion_type": "inclusion",
              "criterion": "Patient age should be within trial bounds.",
              "structured_value": {
                "min_age": 18,
            ...
            {
              "criterion_id": "NCT05461820-E-active-autoimmune-disease",
              "criterion_type": "exclusion",
              "criterion": "Exclude if patient has active autoimmune disease.",
              "structured_value": "active_autoimmune_disease",
              "required": true
            ...
            {
              "criterion_id": "NCT05461820-E-uncontrolled-cardiac-disease",
              "criterion_type": "exclusion",
              "criterion": "Exclude if patient has uncontrolled cardiac disease.",
              "structured_value": "uncontrolled_cardiac_disease",
              "required": true
          ...
          "raw_criteria_excerpt": {
            ...
            "exclusion": [
              ...
              "Blood routine: the total number of white blood cells \\< 3.0109 or neutrophils \\< 1.5 109",
    ...
    {
      "patient_id": "SYN-GEN-00015",
      "patient_information_string": "Oncology referral note: SYN-GEN-00015 is a 26-year-old female with graves disease. No formal stage is documented. ECOG performance status is not documented. Molecular testing results are not available in the note. No prior systemic therapy is listed in the referral. No explicit exclusion comorbidities are addressed. The patient receives care in MA. The note is a synthetic record created for software testing, not a real patient chart.",
      "synthetic_source_profile": {
        "patient_id": "SYN-GEN-00015",
        "age": 26,
        "sex": "female",
        ...
        "target_trial_id": "NCT05678374"
      },
      "candidate_trials": [
        {
          "trial_id": "NCT05678374",
          "title": "Exploring Immunological Markers Associated With Mental Fatigue in Graves' Disease",
          "source_url": "https://clinicaltrials.gov/study/NCT05678374",
          "retrieval_rank": 1,
          "retrieval_score": 1.0,
          "conditions": [
            "Graves Disease",
          ...
          "criteria_to_assess": [
            {
              "criterion_id": "NCT05678374-I-condition",
              "criterion_type": "inclusion",
              "criterion": "Patient diagnosis should match the trial condition.",
              "structured_value": [
                "Graves Disease",
            ...
            {
              "criterion_id": "NCT05678374-I-age",
              "criterion_type": "inclusion",
              "criterion": "Patient age should be within trial bounds.",
              "structured_value": {
                "min_age": 18,
