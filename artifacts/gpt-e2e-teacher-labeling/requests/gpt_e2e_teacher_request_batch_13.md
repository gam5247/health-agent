...
{
  "batch_id": "gpt_e2e_teacher_batch_13",
  "patients": [
    {
      "patient_id": "SYN-GEN-00061",
      "patient_information_string": "Oncology referral note: SYN-GEN-00061 is a 18-year-old female with aspergillosis invasive. Stage is recorded as III. ECOG performance status is 3. Molecular testing results are not available in the note. No prior systemic therapy is listed in the referral. No explicit exclusion comorbidities are addressed. The patient receives care in CA. The note is a synthetic record created for software testing, not a real patient chart.",
      "synthetic_source_profile": {
        "patient_id": "SYN-GEN-00061",
        "age": 18,
        "sex": "female",
        "diagnosis": "aspergillosis invasive",
        "stage": "III",
        "ecog": 3,
        "location": {
          "country": "US",
        ...
        "target_trial_id": "NCT06440915"
      },
      "candidate_trials": [
        {
          "trial_id": "NCT06440915",
          "title": "Study on Theraputic Drug Monitoring and Phamacokinetics of Isavuconazole in Children",
          "source_url": "https://clinicaltrials.gov/study/NCT06440915",
          "retrieval_rank": 1,
          "retrieval_score": 1.0,
          "conditions": [
          ...
          "criteria_to_assess": [
            {
              "criterion_id": "NCT06440915-I-condition",
            ...
            {
              "criterion_id": "NCT06440915-I-age",
              "criterion_type": "inclusion",
    ...
    {
      "patient_id": "SYN-GEN-00062",
      "patient_information_string": "Tumor board intake: SYN-GEN-00062 is a 37-year-old female with relapsed acute myeloid leukemia. Stage is recorded as III. ECOG performance status is 0. Molecular testing results are not available in the note. No prior systemic therapy is listed in the referral. No uncontrolled cardiac disease is reported. The patient receives care in NY. The note is a synthetic record created for software testing, not a real patient chart.",
      "synthetic_source_profile": {
        "patient_id": "SYN-GEN-00062",
        "age": 37,
        "sex": "female",
        ...
        "target_trial_id": "NCT06756191"
      },
      "candidate_trials": [
        {
          "trial_id": "NCT06756191",
          "title": "Antifungal Drugs in Pulmonary Mucormycosis",
          "source_url": "https://clinicaltrials.gov/study/NCT06756191",
          "retrieval_rank": 1,
          "retrieval_score": 1.0,
          "conditions": [
          ...
          "criteria_to_assess": [
            {
              "criterion_id": "NCT06756191-I-condition",
              "criterion_type": "inclusion",
              "criterion": "Patient diagnosis should match the trial condition.",
              "structured_value": [
                "Pulmonary Mucormycosis"
            ...
            {
              "criterion_id": "NCT06756191-I-age",
              "criterion_type": "inclusion",
              "criterion": "Patient age should be within trial bounds.",
              "structured_value": {
                "min_age": 18,
            ...
            {
              "criterion_id": "NCT06756191-E-uncontrolled-cardiac-disease",
              "criterion_type": "exclusion",
              "criterion": "Exclude if patient has uncontrolled cardiac disease.",
              "structured_value": "uncontrolled_cardiac_disease",
              "required": true
    ...
    {
      "patient_id": "SYN-GEN-00063",
      "patient_information_string": "Oncology referral note: SYN-GEN-00063 is a 81-year-old male with mucormycosis. No formal stage is documented. ECOG performance status is not documented. Molecular testing results are not available in the note. No prior systemic therapy is listed in the referral. No explicit exclusion comorbidities are addressed. The patient receives care in TX. The note is a synthetic record created for software testing, not a real patient chart.",
      "synthetic_source_profile": {
        "patient_id": "SYN-GEN-00063",
        "age": 81,
        "sex": "male",
        ...
        "target_trial_id": "NCT07191756"
      },
      "candidate_trials": [
        {
          "trial_id": "NCT07191756",
          "title": "Amphotericin B Versus Isavuconazole for Mucormycosis: A Comparative Efficacy and Safety Study",
          "source_url": "https://clinicaltrials.gov/study/NCT07191756",
          "retrieval_rank": 1,
          "retrieval_score": 1.0,
          "conditions": [
            "Mucormycosis"
          ...
          "criteria_to_assess": [
            {
              "criterion_id": "NCT07191756-I-condition",
              "criterion_type": "inclusion",
              "criterion": "Patient diagnosis should match the trial condition.",
              "structured_value": [
                "Mucormycosis"
          ...
          "raw_criteria_excerpt": {
            "inclusion": [
              "1. Confirmed diagnosis of mucormycosis based on histopathology, culture, or typical radiographic findings in accordance with established guidelines.",
              "2. Received primary antifungal treatment for mucormycosis with either amphotericin B (any formulation) or isavuconazole for at least 48 hours.",
              "3. Had at least one follow-up assessment after initiation of antifungal therapy to evaluate treatment response.",
              "4. Medical records from the participating hospitals are sufficiently complete for data extraction regarding treatment and outcomes."
            ],
            "exclusion": [
              "Patients who were not treated with amphotericin B or isavuconazole; and patients who did not have mucormycosis."
            ],
            "eligibility_criteria_excerpt": "Inclusion Criteria: 1. Confirmed diagnosis of mucormycosis based on histopathology, culture, or typical radiographic findings in accordance with established guidelines. 2. Received primary antifungal treatment for mucormycosis with either amphotericin B (any formulation) or isavuconazole for at least 48 hours. 3. Had at least one follow-up assessment after initiation of antifungal therapy to evaluate treatment response. 4. Medical records from the participating hospitals are sufficiently complete for data extraction regarding treatment and outcomes. Exclusion Criteria: * Patients who were not treated with amphotericin B or isavuconazole; and patients who did not have mucormycosis."
          }
        },
        {
          "trial_id": "NCT03237780",
    ...
    {
      "patient_id": "SYN-GEN-00064",
      "patient_information_string": "Tumor board intake: SYN-GEN-00064 is a 56-year-old female with mucorales infection. No formal stage is documented. ECOG performance status is 1. Molecular testing results are not available in the note. No prior systemic therapy is listed in the referral. No explicit exclusion comorbidities are addressed. The patient receives care in WA. The note is a synthetic record created for software testing, not a real patient chart.",
      "synthetic_source_profile": {
        "patient_id": "SYN-GEN-00064",
        "age": 56,
        "sex": "female",
        "diagnosis": "mucorales infection",
        "ecog": 1,
        "location": {
          "country": "US",
          "state": "WA"
        ...
        "target_trial_id": "NCT05406037"
      },
      "candidate_trials": [
        {
          "trial_id": "NCT05406037",
          "title": "Biomarkers for Invasive Mucormycosis",
          "source_url": "https://clinicaltrials.gov/study/NCT05406037",
          "retrieval_rank": 1,
          "retrieval_score": 1.0,
          "conditions": [
            "Mucorales Infection",
          ...
          "criteria_to_assess": [
            {
              "criterion_id": "NCT05406037-I-condition",
              "criterion_type": "inclusion",
              "criterion": "Patient diagnosis should match the trial condition.",
              "structured_value": [
                "Mucorales Infection",
            ...
            {
              "criterion_id": "NCT05406037-I-age",
              "criterion_type": "inclusion",
              "criterion": "Patient age should be within trial bounds.",
              "structured_value": {
                "min_age": 3,
    ...
    },
    {
      ...
      "synthetic_source_profile": {
        ...
        "target_trial_id": "NCT06515743"
      },
      "candidate_trials": [
        {
          "trial_id": "NCT06515743",
          "title": "Rehabilitation With an Obturator in Maxillary Defects",
          "source_url": "https://clinicaltrials.gov/study/NCT06515743",
          "retrieval_rank": 1,
          "retrieval_score": 1.0,
          "conditions": [
            "Mucormycosis"
          ...
          "criteria_to_assess": [
            {
              "criterion_id": "NCT06515743-I-condition",
              "criterion_type": "inclusion",
              "criterion": "Patient diagnosis should match the trial condition.",
              "structured_value": [
                "Mucormycosis"
            ...
            {
              "criterion_id": "NCT06515743-I-age",
              "criterion_type": "inclusion",
              "criterion": "Patient age should be within trial bounds.",
              "structured_value": {
                "min_age": 30,
          ...
          "raw_criteria_excerpt": {
            ...
            "eligibility_criteria_excerpt": "Inclusion Criteria: \\*Patients who underwent partial, subtotal and hemi-maxillectomy due to COVID-19-associated mucormycosis and who needed the prosthetic rehabilitation with delayed surgical obturator. Exclusion Criteria: * Patients who are unwilling for the study. * Patients who underwent which bilateral maxillectomies. * Patients having extensive palatal mucosal loss."
          }
        },
        {
          "trial_id": "NCT03237780",
