...
{
  "batch_id": "gpt_e2e_teacher_batch_01",
  "patients": [
    {
      "patient_id": "SYN-GEN-00001",
      ...
      "candidate_trials": [
        {
          ...
          "criteria_to_assess": [
            {
              "criterion_id": "NCT06401577-I-condition",
            ...
            {
              "criterion_id": "NCT06401577-I-age",
              "criterion_type": "inclusion",
            ...
            {
              "criterion_id": "NCT06401577-E-organ-transplant",
    ...
    },
    {
      ...
      "synthetic_source_profile": {
        ...
        "age": 73,
        "sex": "female",
        "diagnosis": "post-ercp acute pancreatitis",
        "stage": "III",
        "ecog": 0,
        "flags": {
        ...
        "target_trial_id": "NCT03215862"
      },
      "candidate_trials": [
        {
          "trial_id": "NCT03215862",
          "title": "Lactated Ringer's Solution to Prevent Post-ERCP Pancreatitis",
          "source_url": "https://clinicaltrials.gov/study/NCT03215862",
          "retrieval_rank": 1,
          "retrieval_score": 1.0,
          "conditions": [
          ...
          "criteria_to_assess": [
            {
              "criterion_id": "NCT03215862-I-condition",
              "criterion_type": "inclusion",
              "criterion": "Patient diagnosis should match the trial condition.",
              "structured_value": [
                "Post-ERCP Acute Pancreatitis"
            ...
            {
              "criterion_id": "NCT03215862-I-age",
              "criterion_type": "inclusion",
              "criterion": "Patient age should be within trial bounds.",
              "structured_value": {
                "min_age": 18,
            ...
            {
              "criterion_id": "NCT03215862-E-uncontrolled-cardiac-disease",
              "criterion_type": "exclusion",
              "criterion": "Exclude if patient has uncontrolled cardiac disease.",
              "structured_value": "uncontrolled_cardiac_disease",
              "required": true
    ...
    },
    {
      ...
      "synthetic_source_profile": {
        ...
        "target_trial_id": "NCT07184593"
      },
      "candidate_trials": [
        {
          "trial_id": "NCT07184593",
          "title": "Nucleosome Monitoring Relevance for Outcome Prediction in Critically Ill Patients",
          "source_url": "https://clinicaltrials.gov/study/NCT07184593",
          "retrieval_rank": 1,
          "retrieval_score": 1.0,
          "conditions": [
            "Sepsis",
          ...
          "criteria_to_assess": [
            {
              "criterion_id": "NCT07184593-I-condition",
              "criterion_type": "inclusion",
              "criterion": "Patient diagnosis should match the trial condition.",
              "structured_value": [
                "Sepsis",
            ...
            {
              "criterion_id": "NCT07184593-I-age",
              "criterion_type": "inclusion",
              "criterion": "Patient age should be within trial bounds.",
              "structured_value": {
                "min_age": 18,
    ...
    },
    {
      ...
      "synthetic_source_profile": {
        ...
        "age": 20,
        "sex": "female",
        "diagnosis": "metastatic pancreatic ductal adenocarcinoma (mpdac)",
        "stage": "I",
        "ecog": 2,
        "location": {
          "country": "US",
        ...
        "target_trial_id": "NCT07144917"
      },
      "candidate_trials": [
        {
          "trial_id": "NCT07144917",
          "title": "Immunoparalysis After Pancreaticoduodenectomy",
          "source_url": "https://clinicaltrials.gov/study/NCT07144917",
          "retrieval_rank": 1,
          "retrieval_score": 1.0,
          "conditions": [
          ...
          "criteria_to_assess": [
            {
              "criterion_id": "NCT07144917-I-condition",
              "criterion_type": "inclusion",
              "criterion": "Patient diagnosis should match the trial condition.",
              "structured_value": [
                "Pancreatic Ductal Adenocarcinoma (mPDAC)",
            ...
            {
              "criterion_id": "NCT07144917-I-age",
              "criterion_type": "inclusion",
              "criterion": "Patient age should be within trial bounds.",
              "structured_value": {
                "min_age": 18,
    ...
    },
    {
      ...
      "synthetic_source_profile": {
        ...
        "age": 56,
        "sex": "male",
        "diagnosis": "acute pancreatitis (ap)",
        "ecog": 3,
        "location": {
          "country": "US",
          "state": "MA"
        ...
        "target_trial_id": "NCT07233551"
      },
      "candidate_trials": [
        {
          "trial_id": "NCT07233551",
          "title": "Utilization of CBC-Derived Inflammatory Indices in Assessing Severity and Prognosis of Acute Pancreatitis.",
          "source_url": "https://clinicaltrials.gov/study/NCT07233551",
          "retrieval_rank": 1,
          "retrieval_score": 1.0,
          "conditions": [
          ...
          "criteria_to_assess": [
            {
              "criterion_id": "NCT07233551-I-condition",
              "criterion_type": "inclusion",
              "criterion": "Patient diagnosis should match the trial condition.",
              "structured_value": [
                "Acute Pancreatitis (AP)",
            ...
            {
              "criterion_id": "NCT07233551-I-age",
              "criterion_type": "inclusion",
              "criterion": "Patient age should be within trial bounds.",
              "structured_value": {
                "min_age": 18,
          ...
          "raw_criteria_excerpt": {
            ...
            "eligibility_criteria_excerpt": "Inclusion Criteria: 1. adult patients aged 18 years old or older. 2. patients with acute pancreatitis who were treated in our hospital from January 2019 to March 2025. Exclusion Criteria: 1. history of chronic kidney disease 2. Pregnancy. 3. History of neoplasm 4. present of acute infection 5. history of hematological diseases"
          }
        },
        {
          "trial_id": "NCT03237780",
