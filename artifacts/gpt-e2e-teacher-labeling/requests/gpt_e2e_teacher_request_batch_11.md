...
{
  "batch_id": "gpt_e2e_teacher_batch_11",
  "patients": [
    {
      "patient_id": "SYN-GEN-00051",
      "patient_information_string": "Oncology referral note: SYN-GEN-00051 is a 72-year-old female with migraine. Stage is recorded as IV. ECOG performance status is 1. Molecular testing results are not available in the note. No prior systemic therapy is listed in the referral. The note reports uncontrolled cardiac disease. The patient receives care in CA. The note is a synthetic record created for software testing, not a real patient chart.",
    ...
    {
      "patient_id": "SYN-GEN-00052",
      "patient_information_string": "Tumor board intake: SYN-GEN-00052 is a 8-year-old male with acute treatment of migraine. Stage is recorded as I. ECOG performance status is 1. Molecular testing results are not available in the note. No prior systemic therapy is listed in the referral. No explicit exclusion comorbidities are addressed. The patient receives care in NY. The note is a synthetic record created for software testing, not a real patient chart.",
      "synthetic_source_profile": {
        "patient_id": "SYN-GEN-00052",
        "age": 8,
        "sex": "male",
        "diagnosis": "acute treatment of migraine",
        "stage": "I",
        "ecog": 1,
        "location": {
          "country": "US",
        ...
        "target_trial_id": "NCT04743141"
      },
      "candidate_trials": [
        {
          "trial_id": "NCT04743141",
          "title": "Long-term Safety Study of Rimegepant in Pediatric Subjects for the Acute Treatment of Migraine",
          "source_url": "https://clinicaltrials.gov/study/NCT04743141",
          "retrieval_rank": 1,
          "retrieval_score": 1.0,
          "conditions": [
          ...
          "criteria_to_assess": [
            {
              "criterion_id": "NCT04743141-I-condition",
              "criterion_type": "inclusion",
              "criterion": "Patient diagnosis should match the trial condition.",
              "structured_value": [
                "Acute Treatment of Migraine"
            ...
            {
              "criterion_id": "NCT04743141-I-age",
              "criterion_type": "inclusion",
              "criterion": "Patient age should be within trial bounds.",
              "structured_value": {
                "min_age": 6,
    ...
    {
      "patient_id": "SYN-GEN-00053",
      "patient_information_string": "Oncology referral note: SYN-GEN-00053 is a 39-year-old male with migraine. Stage is recorded as IV. ECOG performance status is 3. Molecular testing results are not available in the note. No prior systemic therapy is listed in the referral. No explicit exclusion comorbidities are addressed. The patient receives care in TX. The note is a synthetic record created for software testing, not a real patient chart.",
      "synthetic_source_profile": {
        "patient_id": "SYN-GEN-00053",
        "age": 39,
        "sex": "male",
        ...
        "target_trial_id": "NCT06414044"
      },
      "candidate_trials": [
        {
          "trial_id": "NCT06414044",
          "title": "Italian Real-life obServational Study on the effecTiveness, sAfety and Tolerability of Atogepant in Migraine Patients",
          "source_url": "https://clinicaltrials.gov/study/NCT06414044",
          "retrieval_rank": 1,
          "retrieval_score": 1.0,
          "conditions": [
            "Migraine",
          ...
          "criteria_to_assess": [
            {
              "criterion_id": "NCT06414044-I-condition",
              "criterion_type": "inclusion",
              "criterion": "Patient diagnosis should match the trial condition.",
              "structured_value": [
                "Migraine",
            ...
            {
              "criterion_id": "NCT06414044-I-age",
              "criterion_type": "inclusion",
              "criterion": "Patient age should be within trial bounds.",
              "structured_value": {
                "min_age": 18,
    ...
    },
    {
      ...
      "synthetic_source_profile": {
        ...
        "target_trial_id": "NCT04715685"
      },
      "candidate_trials": [
        {
          "trial_id": "NCT04715685",
          "title": "Mind Body Balance for Pediatric Migraine",
          "source_url": "https://clinicaltrials.gov/study/NCT04715685",
          "retrieval_rank": 1,
          "retrieval_score": 1.0,
          "conditions": [
            "Headache",
          ...
          "criteria_to_assess": [
            {
              "criterion_id": "NCT04715685-I-condition",
              "criterion_type": "inclusion",
              "criterion": "Patient diagnosis should match the trial condition.",
              "structured_value": [
                "Headache",
            ...
            {
              "criterion_id": "NCT04715685-I-age",
              "criterion_type": "inclusion",
              "criterion": "Patient age should be within trial bounds.",
              "structured_value": {
                "min_age": 10,
    ...
    {
      "patient_id": "SYN-GEN-00055",
      "patient_information_string": "Oncology referral note: SYN-GEN-00055 is a 49-year-old male with migraine. No formal stage is documented. ECOG performance status is not documented. Molecular testing results are not available in the note. No prior systemic therapy is listed in the referral. No explicit exclusion comorbidities are addressed. The patient receives care in MA. The note is a synthetic record created for software testing, not a real patient chart.",
      "synthetic_source_profile": {
        "patient_id": "SYN-GEN-00055",
        "age": 49,
        "sex": "male",
        ...
        "target_trial_id": "NCT07022496"
      },
      "candidate_trials": [
        {
          "trial_id": "NCT07022496",
          "title": "Assessment of Oral Caffeine Intake in Changing the Severity of Acute Migraine Attack Using VAS Score Among Patients Attending Headache and Neurology Outpatients Clinic of Ainshams University Hospitals",
          "source_url": "https://clinicaltrials.gov/study/NCT07022496",
          "retrieval_rank": 1,
          "retrieval_score": 1.0,
          "conditions": [
            "Migraine",
          ...
          "criteria_to_assess": [
            {
              "criterion_id": "NCT07022496-I-condition",
              "criterion_type": "inclusion",
              "criterion": "Patient diagnosis should match the trial condition.",
              "structured_value": [
                "Migraine",
            ...
            {
              "criterion_id": "NCT07022496-I-age",
              "criterion_type": "inclusion",
              "criterion": "Patient age should be within trial bounds.",
              "structured_value": {
                "min_age": 18,
          ...
          "raw_criteria_excerpt": {
            ...
            "eligibility_criteria_excerpt": "Inclusion Criteria: Patients suffering from migraine with aura, migraine without aura, episodic, and chronic migraine according to ICHD-3 diagnosis will be legible for the study. Exclusion Criteria: Patients who have history of any cardiac dysrhythmia, hypertension, ischemic heart disease, active peptic ulcer disease, inflammatory bowel disease, obsessive compulsive disorder, pregnancy, breast-feeding, renal failure, hepatic failure, sleep disorder, mental retardation, and history of substance abuse that prevent them from cooperating with us during the study Patients who had headache due to: Cluster headache, trigeminal neuralgia, glossopharyngeal neuralgia, headache secondary to trauma, cranial disorder, vascular disorder, infection, or mass lesion, will also be excluded"
          }
        },
        {
          "trial_id": "NCT03237780",
