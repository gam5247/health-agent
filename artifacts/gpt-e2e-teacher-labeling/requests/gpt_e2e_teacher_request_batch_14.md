...
{
  "batch_id": "gpt_e2e_teacher_batch_14",
  "patients": [
    {
      "patient_id": "SYN-GEN-00066",
      "patient_information_string": "Tumor board intake: SYN-GEN-00066 is a 44-year-old female with hemifacial microsomia. Stage is recorded as III. ECOG performance status is 0. Molecular testing results are not available in the note. No prior systemic therapy is listed in the referral. No explicit exclusion comorbidities are addressed. The patient receives care in IL. The note is a synthetic record created for software testing, not a real patient chart.",
      "synthetic_source_profile": {
        "patient_id": "SYN-GEN-00066",
        "age": 44,
        "sex": "female",
        "diagnosis": "hemifacial microsomia",
        "stage": "III",
        "ecog": 0,
        "location": {
          "country": "US",
        ...
        "target_trial_id": "NCT07654647"
      },
      "candidate_trials": [
        {
          "trial_id": "NCT07654647",
          "title": "Clinical Evaluation of Patient-Specific 3D-Printed Titanium Implants for Facial Reconstruction.",
          "source_url": "https://clinicaltrials.gov/study/NCT07654647",
          "retrieval_rank": 1,
          "retrieval_score": 1.0,
          "conditions": [
          ...
          "criteria_to_assess": [
            {
              "criterion_id": "NCT07654647-I-condition",
            ...
            {
              "criterion_id": "NCT07654647-I-age",
              "criterion_type": "inclusion",
    ...
    {
      "patient_id": "SYN-GEN-00067",
      "patient_information_string": "Oncology referral note: SYN-GEN-00067 is a 23-year-old male with fungal infection. Stage is recorded as III. ECOG performance status is 1. Molecular testing results are not available in the note. No prior systemic therapy is listed in the referral. No explicit exclusion comorbidities are addressed. The patient receives care in FL. The note is a synthetic record created for software testing, not a real patient chart.",
      "synthetic_source_profile": {
        "patient_id": "SYN-GEN-00067",
        "age": 23,
        "sex": "male",
        ...
        "target_trial_id": "NCT07080359"
      },
      "candidate_trials": [
        {
          "trial_id": "NCT07080359",
          "title": "Isavuconazole in Critically Ill Patients: Efficacy and Safety",
          "source_url": "https://clinicaltrials.gov/study/NCT07080359",
          "retrieval_rank": 1,
          "retrieval_score": 1.0,
          "conditions": [
            "Fungal Infection",
          ...
          "criteria_to_assess": [
            {
              "criterion_id": "NCT07080359-I-condition",
              "criterion_type": "inclusion",
              "criterion": "Patient diagnosis should match the trial condition.",
              "structured_value": [
                "Fungal Infection",
            ...
            {
              "criterion_id": "NCT07080359-I-age",
              "criterion_type": "inclusion",
              "criterion": "Patient age should be within trial bounds.",
              "structured_value": {
                "min_age": 18,
          ...
          "raw_criteria_excerpt": {
            ...
            "eligibility_criteria_excerpt": "Inclusion Criteria: * Adult critically ill patients (>=18 years) admitted to ICU with suspected or confirmed invasive fungal infection (IFI) * IFI diagnosis per EORTC/MSGERC 2019 criteria Exclusion Criteria: * Drug allergy * Inherited short QT syndrome * Contraindications for nasogastric/oral drug delivery * \\<18 years old"
          }
        },
        {
          "trial_id": "NCT03237780",
    ...
    {
      "patient_id": "SYN-GEN-00068",
      "patient_information_string": "Tumor board intake: SYN-GEN-00068 is a 26-year-old female with pulmonary mucormycosis. Stage is recorded as I. ECOG performance status is 0. Molecular testing results are not available in the note. No prior systemic therapy is listed in the referral. No explicit exclusion comorbidities are addressed. The patient receives care in PA. The note is a synthetic record created for software testing, not a real patient chart.",
      "synthetic_source_profile": {
        "patient_id": "SYN-GEN-00068",
        "age": 26,
        "sex": "female",
        ...
        "target_trial_id": "NCT07339800"
      },
      "candidate_trials": [
        {
          "trial_id": "NCT07339800",
          "title": "Chest CT Scan in Pulmonary Mucormycosis: Prognostic Value",
          "source_url": "https://clinicaltrials.gov/study/NCT07339800",
          "retrieval_rank": 1,
          "retrieval_score": 1.0,
          "conditions": [
          ...
          "criteria_to_assess": [
            {
              "criterion_id": "NCT07339800-I-condition",
              "criterion_type": "inclusion",
              "criterion": "Patient diagnosis should match the trial condition.",
              "structured_value": [
                "Pulmonary Mucormycosis"
            ...
            {
              "criterion_id": "NCT07339800-I-age",
              "criterion_type": "inclusion",
              "criterion": "Patient age should be within trial bounds.",
              "structured_value": {
                "min_age": 18,
    ...
    {
      "patient_id": "SYN-GEN-00069",
      "patient_information_string": "Oncology referral note: SYN-GEN-00069 is a 52-year-old female with mucormycosis in hematologic malignancies. Stage is recorded as III. ECOG performance status is 3. Molecular testing results are not available in the note. No prior systemic therapy is listed in the referral. No explicit exclusion comorbidities are addressed. The patient receives care in CO. The note is a synthetic record created for software testing, not a real patient chart.",
      "synthetic_source_profile": {
        "patient_id": "SYN-GEN-00069",
        "age": 52,
        "sex": "female",
        "diagnosis": "mucormycosis in hematologic malignancies",
        "stage": "III",
        "ecog": 3,
        "location": {
          "country": "US",
        ...
        "target_trial_id": "NCT07185503"
      },
      "candidate_trials": [
        {
          "trial_id": "NCT07185503",
          "title": "Liposomal Amphotericin B Plus Posaconazole/Isavuconazole for Mucormycosis in Hematologic Malignancies: Efficacy and Safety",
          "source_url": "https://clinicaltrials.gov/study/NCT07185503",
          "retrieval_rank": 1,
          "retrieval_score": 1.0,
          "conditions": [
          ...
          "criteria_to_assess": [
            {
              "criterion_id": "NCT07185503-I-condition",
              "criterion_type": "inclusion",
              "criterion": "Patient diagnosis should match the trial condition.",
              "structured_value": [
                "Mucormycosis in Hematologic Malignancies"
            ...
            {
              "criterion_id": "NCT07185503-I-age",
              "criterion_type": "inclusion",
              "criterion": "Patient age should be within trial bounds.",
              "structured_value": {
                "min_age": 18,
            ...
            {
              "criterion_id": "NCT07185503-I-ecog",
              "criterion_type": "inclusion",
              "criterion": "Patient ECOG performance status should be at or below the maximum.",
              "structured_value": 2,
              "required": true
    ...
    {
      "patient_id": "SYN-GEN-00070",
      "patient_information_string": "Tumor board intake: SYN-GEN-00070 is a 57-year-old female with advanced renal cell carcinoma. Stage is recorded as III. ECOG performance status is 0. Molecular testing results are not available in the note. No prior systemic therapy is listed in the referral. No explicit exclusion comorbidities are addressed. The patient receives care in AZ. The note is a synthetic record created for software testing, not a real patient chart.",
      "synthetic_source_profile": {
        "patient_id": "SYN-GEN-00070",
        "age": 57,
        "sex": "female",
        ...
        "target_trial_id": "NCT06878144"
      },
      "candidate_trials": [
        {
          "trial_id": "NCT06878144",
          "title": "Mucormycosis Clinical Core for the MUCOR-ADVANCE P01 Project",
          "source_url": "https://clinicaltrials.gov/study/NCT06878144",
          "retrieval_rank": 1,
          "retrieval_score": 1.0,
          "conditions": [
            "Mucormycosis"
          ...
          "criteria_to_assess": [
            {
              "criterion_id": "NCT06878144-I-condition",
              "criterion_type": "inclusion",
              "criterion": "Patient diagnosis should match the trial condition.",
              "structured_value": [
                "Mucormycosis"
            ...
            {
              "criterion_id": "NCT06878144-I-age",
              "criterion_type": "inclusion",
              "criterion": "Patient age should be within trial bounds.",
              "structured_value": {
                "min_age": 18,
          ...
          "raw_criteria_excerpt": {
            ...
            "eligibility_criteria_excerpt": "Inclusion Criteria: * Patients must be 18-100 years old and have cancer and invasive mucormycosis, invasive aspergillosis, bacterial pneumonia, or a risk for fungal infection but no evidence of such infection. * Patients must be willing to undergo routine diagnostic procedures (e.g., phlebotomy, bronchoscopy, biopsy) as part of their regular care. Exclusion Criteria: Patients who are unwilling to undergo routine diagnostic procedures as part of their regular care."
          }
        },
        {
          "trial_id": "NCT03237780",
