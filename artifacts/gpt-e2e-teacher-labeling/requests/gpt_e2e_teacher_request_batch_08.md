  ...
  "patients": [
    {
      ...
      "synthetic_source_profile": {
        ...
        "target_trial_id": "NCT06185257"
      },
      "candidate_trials": [
        {
          "trial_id": "NCT06185257",
          "title": "Electroencephalographic Changes in Nonconvulsive Children With Chronic Renal Disease",
          "source_url": "https://clinicaltrials.gov/study/NCT06185257",
          "retrieval_rank": 1,
          "retrieval_score": 1.0,
          "conditions": [
          ...
          "criteria_to_assess": [
            {
              "criterion_id": "NCT06185257-I-condition",
            ...
            {
              "criterion_id": "NCT06185257-I-age",
              "criterion_type": "inclusion",
          ...
          "raw_criteria_excerpt": {
            ...
            "eligibility_criteria_excerpt": "Inclusion Criteria: * All children with chronic kidney disease and nephrotic syndrome Exclusion Criteria: * Newborn * Patients with genetic disease Neurological disorder"
          }
        },
        {
    ...
    {
      "patient_id": "SYN-GEN-00037",
      "patient_information_string": "Oncology referral note: SYN-GEN-00037 is a 64-year-old female with metastatic bladder cancer. No formal stage is documented. ECOG performance status is 1. Molecular testing results are not available in the note. No prior systemic therapy is listed in the referral. No active interstitial lung disease is reported. No uncontrolled cardiac disease is reported. No active uncontrolled infection is reported. The patient receives care in FL. The note is a synthetic record created for software testing, not a real patient chart.",
      "synthetic_source_profile": {
        "patient_id": "SYN-GEN-00037",
        "age": 64,
        "sex": "female",
        ...
        "target_trial_id": "NCT06493370"
      },
      "candidate_trials": [
        {
          "trial_id": "NCT06493370",
          ...
          "source_url": "https://clinicaltrials.gov/study/NCT06493370",
          "retrieval_rank": 1,
          "retrieval_score": 1.0,
          "conditions": [
            "Bladder Cancer"
          ...
          "criteria_to_assess": [
            {
              "criterion_id": "NCT06493370-I-condition",
              "criterion_type": "inclusion",
              "criterion": "Patient diagnosis should match the trial condition.",
              "structured_value": [
                "Bladder Cancer"
            ...
            {
              "criterion_id": "NCT06493370-I-age",
              "criterion_type": "inclusion",
              "criterion": "Patient age should be within trial bounds.",
              "structured_value": {
                "min_age": 18,
            ...
            {
              "criterion_id": "NCT06493370-I-ecog",
              "criterion_type": "inclusion",
              "criterion": "Patient ECOG performance status should be at or below the maximum.",
              "structured_value": 0,
              "required": true
            ...
            {
              "criterion_id": "NCT06493370-E-active-interstitial-lung-disease",
              "criterion_type": "exclusion",
              "criterion": "Exclude if patient has active interstitial lung disease.",
              "structured_value": "active_interstitial_lung_disease",
              "required": true
            ...
            {
              "criterion_id": "NCT06493370-E-uncontrolled-cardiac-disease",
              "criterion_type": "exclusion",
              "criterion": "Exclude if patient has uncontrolled cardiac disease.",
              "structured_value": "uncontrolled_cardiac_disease",
              "required": true
            ...
            {
              "criterion_id": "NCT06493370-E-active-uncontrolled-infection",
              "criterion_type": "exclusion",
              "criterion": "Exclude if patient has active uncontrolled infection.",
              "structured_value": "active_uncontrolled_infection",
              "required": true
    ...
    {
      "patient_id": "SYN-GEN-00038",
      "patient_information_string": "Tumor board intake: SYN-GEN-00038 is a 23-year-old female with relapsed acute myeloid leukemia. Stage is recorded as III. ECOG performance status is 1. Molecular testing results are not available in the note. No prior systemic therapy is listed in the referral. No explicit exclusion comorbidities are addressed. The patient receives care in PA. The note is a synthetic record created for software testing, not a real patient chart.",
      "synthetic_source_profile": {
        "patient_id": "SYN-GEN-00038",
        "age": 23,
        "sex": "female",
        ...
        "target_trial_id": "NCT00938145"
      },
      "candidate_trials": [
        {
          "trial_id": "NCT00938145",
          "title": "3 Tesla MRI in Patients With Bladder Cancer",
          "source_url": "https://clinicaltrials.gov/study/NCT00938145",
          "retrieval_rank": 1,
          "retrieval_score": 1.0,
          "conditions": [
            "Bladder Cancer"
          ...
          "criteria_to_assess": [
            {
              "criterion_id": "NCT00938145-I-condition",
              "criterion_type": "inclusion",
              "criterion": "Patient diagnosis should match the trial condition.",
              "structured_value": [
                "Bladder Cancer"
            ...
            {
              "criterion_id": "NCT00938145-I-age",
              "criterion_type": "inclusion",
              "criterion": "Patient age should be within trial bounds.",
              "structured_value": {
                "min_age": 18,
    ...
    {
      "patient_id": "SYN-GEN-00039",
      "patient_information_string": "Oncology referral note: SYN-GEN-00039 is a 69-year-old male with metastatic bladder cancer. Stage is recorded as III. ECOG performance status is not documented. Molecular testing results are not available in the note. No prior systemic therapy is listed in the referral. No uncontrolled cardiac disease is reported. The patient receives care in CO. The note is a synthetic record created for software testing, not a real patient chart.",
      "synthetic_source_profile": {
        "patient_id": "SYN-GEN-00039",
        "age": 69,
        "sex": "male",
        ...
        "target_trial_id": "NCT07260162"
      },
      "candidate_trials": [
        {
          "trial_id": "NCT07260162",
          "title": "Evaluation of ATO-101 in Patients With Non-Muscle-Invasive Bladder Cancer (PERSEVERANCE EU)",
          "source_url": "https://clinicaltrials.gov/study/NCT07260162",
          "retrieval_rank": 1,
          "retrieval_score": 1.0,
          "conditions": [
            "Bladder Cancer"
          ...
          "criteria_to_assess": [
            {
              "criterion_id": "NCT07260162-I-condition",
              "criterion_type": "inclusion",
              "criterion": "Patient diagnosis should match the trial condition.",
              "structured_value": [
                "Bladder Cancer"
            ...
            {
              "criterion_id": "NCT07260162-I-age",
              "criterion_type": "inclusion",
              "criterion": "Patient age should be within trial bounds.",
              "structured_value": {
                "min_age": 18,
            ...
            {
              "criterion_id": "NCT07260162-E-uncontrolled-cardiac-disease",
              "criterion_type": "exclusion",
              "criterion": "Exclude if patient has uncontrolled cardiac disease.",
              "structured_value": "uncontrolled_cardiac_disease",
              "required": true
